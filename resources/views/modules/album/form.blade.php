...
<div class='card'>
    <div class='card-body'>
        ...
        <x-form.input name='name_id' label='Name Id' :value="$album->name_id ?? ''" required floating divider />
        <x-form.input name='name_en' label='Name En' :value="$album->name_en ?? ''" floating divider />
        <x-form.photo-upload label='Image' name='image' :value="$album->image ?? null" />
