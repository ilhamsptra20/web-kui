...
<div class="breadcrumb-area bg-f round-20 position-relative z-1">
    <div class="container text-center">
        <ul class="br-menu text-center bg_secondary d-inline-block list-unstyled mb-15">
            ...
            <li class="position-relative fs-13 fw-semibold ls-1 d-inline-block">ANNOUNCEMENTS</li>
        </ul>
        <h2 class="section-title style-one fw-medium font-secondary text-black text-center mb-6">Announcements</h2>
    </div>
</div>
<!-- Breadcrumb End -->
@endsection
